# A lot of the boilerplate is initial code is from Jee Vang
# https://tello.oneoffcoder.com/index.html
# and is licensed under the Creative Commons Attribution 4.0 Int. License
...
class Tello(object):
    ...
    """
    def __init__(self, local_ip, local_port, imperial=True, 
                    command_timeout=.3, 
    ...
    def streamon(self):
        ...
        :return: Response from Tello, 'OK' or 'FALSE'. 
        """
        streamon = self.send_command('streamon')
