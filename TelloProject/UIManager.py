...
next = -1
droneActive = False
# test = Survivor(0.123456, 0.987654, "./found_photos/found_1.png")
# test2 = Survivor(1.123456, 0.987654, "./found_photos/found_2.png")
# survivors = [test, test2]
# test.setId(1)
# test2.setId(2)
...
while True:
    ...
    if next == -1:
        ...
        if next == -2: #if homeScreen returns -2 instead of the next survivor, it will not show another screen and end the program
            break
    else:
